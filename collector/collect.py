...
CATEGORY_RULES = [
    ...
    (re.compile("リュウ|ルーク|春麗|ガイル|ジュリ|ザンギエフ|ケン|豪鬼|ブランカ|ダルシム|キャミィ|ジェイミー|エド|アキ|ラシード|ベガ|テリー|マノン|マリーザ|リリー|キンバリー|ディージェイ|JP|エドモンド本田|マイ|エレナ|サガット|C\\.ヴァイパー|アレックス|イングリッド"), "koy"),
