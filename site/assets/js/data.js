...
DN.CHARACTERS = [
  ...
  'JP', 'エドモンド本田', 'マイ', 'エレナ', 'サガット', 'C.ヴァイパー', 'アレックス', 'イングリッド',
];

// キャラ別フィルターのアイコン用色(実写・公式アートワークは使わず色分けのみで判別)。
// DN.CHARACTERSの並び順で色相を均等分散させて生成した値。
DN.CHARACTER_COLOR = {
  'リュウ': '#C84141', 'ルーク': '#C85C41', '春麗': '#C87741', 'ガイル': '#C89241',
  'ジュリ': '#C8AD41', 'ザンギエフ': '#C8C841', 'ケン': '#ADC841', '豪鬼': '#92C841',
  'ブランカ': '#77C841', 'ダルシム': '#5CC841', 'キャミィ': '#41C841', 'ジェイミー': '#41C85C',
  'エド': '#41C877', 'アキ': '#41C892', 'ラシード': '#41C8AD', 'ベガ': '#41C8C8',
  'テリー': '#41ADC8', 'マノン': '#4192C8', 'マリーザ': '#4177C8', 'リリー': '#415CC8',
  'キンバリー': '#4141C8', 'ディージェイ': '#5C41C8',
  'JP': '#7741C8', 'エドモンド本田': '#9241C8', 'マイ': '#AD41C8', 'エレナ': '#C841C8',
  'サガット': '#C841AD', 'C.ヴァイパー': '#C84192', 'アレックス': '#C84177', 'イングリッド': '#C8415C',
};
